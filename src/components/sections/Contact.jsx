...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 border-t-2 border-structural-dark bg-surface">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-xl font-body mb-8 max-w-md text-structural-dark/80">
            Currently accepting new clients for Q3 2024. Fill out the form or reach out directly via email.
          </p>
          
          <div className="flex flex-col gap-4 font-heading text-lg font-bold">
            <a href="mailto:hello@example.com" className="hover:text-primary-neon hover:bg-structural-dark px-2 -ml-2 transition-colors w-fit">HELLO@EXAMPLE.COM</a>
            <a href="#" className="hover:text-primary-neon hover:bg-structural-dark px-2 -ml-2 transition-colors w-fit">TWITTER / X</a>
            <a href="#" className="hover:text-primary-neon hover:bg-structural-dark px-2 -ml-2 transition-colors w-fit">INSTAGRAM</a>
          </div>
        </motion.div>
        ...
        >
          <form className="flex flex-col gap-6 relative" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2">
              <label htmlFor="name" className="font-heading font-bold uppercase text-sm tracking-widest pl-1">Name</label>
              <input 
                type="text" 
                id="name" 
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="email" className="font-heading font-bold uppercase text-sm tracking-widest pl-1">Email</label>
              <input 
                type="email" 
                id="email" 
                className="w-full bg-surface border-2 border-structural-dark p-4 font-body outline-none focus:border-primary-neon focus:ring-2 focus:ring-structural-dark transition-all rounded-none"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="message" className="font-heading font-bold uppercase text-sm tracking-widest pl-1">Message</label>
              <textarea 
                id="message" 
                rows="4"
            ...
            <Button variant={status === 'success' ? 'primary' : 'dark'} className="w-full mt-4 group" disabled={status === 'success'}>
              <span className={status === 'success' ? 'text-structural-dark' : 'group-hover:text-primary-neon transition-colors'}>
            ...
            {status === 'success' && (
              ...
              >
                <div className="bg-primary-neon font-heading font-bold text-structural-dark text-xl p-6 border-2 border-structural-dark shadow-brutalist text-center uppercase tracking-widest">
                  Thank you! <br/><span className="text-sm font-body normal-case tracking-normal">Your request has been sent.</span>
                </div>
              </motion.div>
            )}
          </form>
